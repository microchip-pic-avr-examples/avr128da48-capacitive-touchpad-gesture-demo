 ...
 */
#define DEF_SEL_FREQ_INIT FREQ_SEL_1
...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(21) | X(16) | X(6) | X(17), Y(22), 2, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2),\
		     FILTER_LEVEL_16																						   \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(21) | X(16) | X(6) | X(17), Y(5), 2, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2), \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(21) | X(16) | X(6) | X(17), Y(23), 2, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2),\
		     FILTER_LEVEL_16																						   \
	}
#define NODE_3_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(21) | X(16) | X(6) | X(17), Y(4), 2, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2), \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_4_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(22) | X(5) | X(23) | X(4), Y(21), 2, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2), \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_5_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(22) | X(5) | X(23) | X(4), Y(16), 2, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2), \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_6_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(22) | X(5) | X(23) | X(4), Y(6), 2, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2),  \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_7_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(22) | X(5) | X(23) | X(4), Y(17), 2, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2), \
		    FILTER_LEVEL_16                                                                                            \
	}
...
#define NODE_8_PARAMS																											 \
	{																															 \
		X(21)|X(16)|X(6)|X(17),Y(22)|Y(5)|Y(23)|Y(4), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_2), \
			FILTER_LEVEL_16																										 \
	}
 ...
 * Range: 0 to 65534
 */
#define SURFACE_CS_START_KEY_H 4
 ...
 * Range: 0 to 255
 */
#define SURFACE_CS_NUM_KEYS_V 4
 ...
 */
#define SURFACE_CS_RESOL_DB SCR_RESOL_DEADBAND(RESOL_7_BIT, DB_NONE)
 ...
 */
#define SURFACE_CS_MIN_CONTACT 45
 ...
 * Default value: 0
 */
#define QTM_AUTOSCAN_NODE 8

/* Touch detection threshold for Low-power node.
 * Range: 10 to 255
 * Default value: 10
 */
#define QTM_AUTOSCAN_THRESHOLD 80
 ...
 * Default: 100
 */
#define QTM_AUTOSCAN_TRIGGER_PERIOD  NODE_SCAN_64MS //100
 ...
 * Default: 5000
 */
#define DEF_TOUCH_TIMEOUT 20000
 ...
 * Default: 2000
 */
#define DEF_TOUCH_DRIFT_PERIOD_MS 5000
